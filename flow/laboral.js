...
const Laboral = async (bot, ctx) => {
    ...
    await sendDelayedReply(bot, userId, "🌟 *Actualización de Datos Laborales* 🌟\n\nPara mantener tu información actualizada en nuestro sistema, " +
    ...
    await sendDelayedReply(bot, userId, "2️⃣ Una vez dentro, dirígete a la sección de 'Datos Laborales' y localiza el icono de configuración ⚙️", 1000);
